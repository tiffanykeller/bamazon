...
function start() {
 console.log("PLEASE SELECT YOUR ITEMS");
  connection.query("SELECT item_id, product_name, price FROM products", function(
    ...
    // asks user for id and units of products
    inquirer
      .prompt([
        {
          name: "idChosen",
          type: "input",
          message:
            "Please enter the ID number of the product you wish to purchase from BAMAZON: "
        },
        {
          name: "unitsPurchased",
          type: "input",
          message:
            "How many units of this product would you like to purchase from BAMAZON?"
        }
      ])
